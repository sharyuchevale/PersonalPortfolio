    ...
    <section id="home" className="min-h-screen flex items-center pt-20 pb-16 relative">
      ...
      <div className="w-full px-4 relative z-10">
        <div className="flex flex-col md:flex-row items-start justify-start">
          <motion.div 
            className="md:w-1/2 lg:w-1/2 mb-10 md:mb-0 md:pr-0 max-h-screen overflow-y-auto pl-0"
          ...
          >
            ...
            <motion.p variants={itemVariants} className="text-white/80 text-base sm:text-lg md:text-lg lg:text-xl max-w-full mb-8 leading-relaxed">
